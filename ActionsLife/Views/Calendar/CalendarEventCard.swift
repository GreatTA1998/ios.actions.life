    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            cardBody
                ...
                .onTapGesture {
                    // `e2fba41`/`c7a355e` Details path: SwiftUI tap on the
                    // painted card body. Must win over hour-grid SpatialTap.
...
/// 16pt layout slot at the bottom of the timed card. A real UIView sits
/// under the painted capsule pixels and pans to `setDuration`. Do not
/// hit-test this rect on the hour scroller (`b40245f`–`9678340`).
